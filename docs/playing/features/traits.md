...
| Snitch | Informs you about events among your mercs (base 50% chance, modified by relationships and leadership); gains reputation over time; +1 hearing range; three times as effective when working undercover in a prison as interrogator or guard — see [Prisoners of war](prisoners.md). |
